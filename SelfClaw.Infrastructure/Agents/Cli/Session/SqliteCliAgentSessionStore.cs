...
/// with a conversation (plan.md 阶段 4, T4.4). Rows live in the <c>cli_agent_sessions</c> table, keyed by
...
/// </summary>
public sealed class SqliteCliAgentSessionStore : ICliAgentSessionStore
{
