...
internal sealed class SubagentCapabilitySource
{
    ...
    internal IReadOnlyList<DirectToolBinding> CreateTools(
    ...
    private static DirectToolBinding Create(
        ...
        => new(AIFunctionFactory.Create(method, new AIFunctionFactoryOptions
        {
            ...
            MarshalResult = (value, _, _) =>
            {
                ...
                return ValueTask.FromResult<object?>(new DirectToolResult(ToolCallStatus.Completed, displayName, content, content.ToString()));
            }
