...
button.active { color: var(--sc-text); }
button.active::after { background: var(--sc-acid); }
button:focus-visible { outline: 2px solid var(--sc-acid); outline-offset: -2px; }
small { margin-left: auto; color: var(--sc-faint); font-family: var(--sc-mono); font-size: 10px; }
</style>
